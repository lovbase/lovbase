...
const en: Dict = {
  ...
  'preview.waking.hint': 'It stops on its own after a while idle; the first start is a little slower.',
  'preview.asleep.title': 'Preview is asleep',
  'preview.asleep.hint': 'The preview stopped after being idle. Your code and data are safe — just start it again.',
