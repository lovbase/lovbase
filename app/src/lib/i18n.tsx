...
const en: Dict = {
  ...
  'preview.asleep.hint': 'The container was recycled after being idle. Your code and data are safe and come back on wake.',
  ...
  'landing.pricing.title': 'Priced per conversation, not per seat',
  'landing.pricing.sub': 'One credit is one agent turn; having Boris generate an interface costs {build}. Free gives you {free} a month, enough to get an idea built.',
  ...
  'pricing.hero.sub': 'One credit is one agent turn. Your databases, tables and finished apps keep running even when credits run out.',
  ...
  'pricing.credits.title': 'Two rates, so you can do the maths yourself',
  'pricing.credits.sub': 'No black-box token billing, and no vague unit like a "premium request".',
  'pricing.credits.turn.title': 'One agent turn',
  'pricing.credits.turn.body': 'You say something, the agent answers, including any schema change it makes along the way.',
  'pricing.credits.build.title': 'One generated interface',
  'pricing.credits.build.body': 'Boris writes and runs the whole frontend inside a sandbox container, so it costs more.',
  ...
  'pricing.faq.credit.a': 'One credit = one agent turn. Sending a message, or having it change the schema, costs {msg}. Having Boris generate an interface runs a coding agent in a container for several minutes and costs {build}. Those are the only two rates, so you can always work out what you have spent.',
