...
# Credit packs (one-off payments; bought credits go to a wallet that does not expire with the period)
STRIPE_PRICE_CREDITS_SMALL=price_...  STRIPE_PRICE_CREDITS_MEDIUM=price_...  STRIPE_PRICE_CREDITS_LARGE=price_...
```
